package com.liugl.alltest.guanggao.paomadeng;
...
public class PaoMaDengActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marqueeFactory1.setOnItemClickListener(new MarqueeFactory.OnItemClickListener<TextView, String>() {
            ...
            public void onItemClickListener(MarqueeFactory.ViewHolder<TextView, String> holder) {
                Toast.makeText(PaoMaDengActivity.this, holder.data, Toast.LENGTH_SHORT).show();
            }
        });
