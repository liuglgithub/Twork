...
import com.liugl.alltest.suoluetu.wandoujia.wegit.DetailScrollView;
import com.liugl.alltest.suoluetu.wandoujia.wegit.SVRootLinearLayout;

public class DetailWanDouJiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_wan_dou_jia);
        ...
        mScrollView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if(!initData) {
                    ...
                    mImageLeftOffsetNum = (DisplayUtils.getScreenWidth(DetailWanDouJiaActivity.this) - mIconImageView.getWidth()) / 2 - getResources().getDimensionPixelOffset(R.dimen.icon_margin);
                    initData = true;
                    startAnimation();
                }
            }
