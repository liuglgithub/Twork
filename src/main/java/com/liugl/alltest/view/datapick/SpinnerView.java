...
public class SpinnerView extends View{
    ...
    public List<String> getmAllDataList() {
        return mAllDataList;
    }

    public void setmAllDataList(List<String> mAllDataList) {
    ...
    public int getmSelectedTextColor() {
    ...
    public int getmSelectedLineColor() {
        return mSelectedLineColor;
    }

    public void setmSelectedLineColor(int mSelectedLineColor) {
        this.mSelectedLineColor = mSelectedLineColor;
        mSelectedLinePaint.setColor(mSelectedLineColor);
    }

    public OnDataSelectedListener getmOnDataSelectedListener() {
        return mOnDataSelectedListener;
    }

    public void setmOnDataSelectedListener(OnDataSelectedListener mOnDataSelectedListener) {
        this.mOnDataSelectedListener = mOnDataSelectedListener;
    }
}
